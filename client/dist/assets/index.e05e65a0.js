var V=Object.defineProperty;var X=(e,n,l)=>n in e?V(e,n,{enumerable:!0,configurable:!0,writable:!0,value:l}):e[n]=l;var d=(e,n,l)=>(X(e,typeof n!="symbol"?n+"":n,l),l);import{s as c,j as o,a as r,u as $,F as v,b as A,r as L,c as F,i as I,f as O,R as U,d as f,N as _,W as q,e as J,B as K}from"./vendor.31eccb40.js";const Q=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))C(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&C(u)}).observe(document,{childList:!0,subtree:!0});function l(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerpolicy&&(i.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?i.credentials="include":a.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function C(a){if(a.ep)return;a.ep=!0;const i=l(a);fetch(a.href,i)}};Q();class t{}d(t,"Black",{base:"#1F1923",hover:"#2F2A35"}),d(t,"White",{base:"#FFFFF0",hover:"#FFFFF0"}),d(t,"Grey",{base:"#9A9A95",hover:"#B2B2AD"}),d(t,"Coal",{base:"#36454F",hover:"#2F3E47"}),d(t,"Red",{base:"#B60000",hover:"#D60000"}),d(t,"Brown",{base:"#8B5A2B",hover:"#A66D3D"}),d(t,"DarkBrown",{base:"#9B2C1B",hover:"#B23D1C"}),d(t,"Gold",{base:"#D4AF37",hover:"#E6C04D"}),d(t,"Green",{base:"#1E760F",hover:"#2E8B1F"}),d(t,"Background",{base:"#FEEFDA",hover:"#FEEFDA"}),d(t,"TrasnparentBlack",{base:"rgba(31, 25, 35, 0.5)",hover:"rgba(31, 25, 35, 0.5)"}),d(t,"InputText",{base:"#353535",hover:"#353535"});var m=(e=>(e.Primary="Roboto mono, monospace",e))(m||{}),h=(e=>(e[e.Regular=400]="Regular",e[e.Medium=500]="Medium",e))(h||{}),b=(e=>(e.XLarge="36px",e.Large="24px",e.Medium="16px",e.Small="14px",e.XSmall="10px",e))(b||{}),x=(e=>(e.XLarge="24px",e.Large="16px",e.Medium="12px",e.Small="10px",e.XSmall="6px",e))(x||{}),w=(e=>(e.Mobile="600px",e))(w||{}),M=(e=>(e.Medium="8px",e.Large="12px",e))(M||{});const y=c.p`
  color: ${({light:e})=>e?t.White.base:t.Black.base};
  font-family: ${m.Primary};
...
`,p=({label:e,onClick:n,color:l,icon:C,gap:a})=>o(Y,{baseColor:l.base,hoverColor:l.hover,value:"Label",onClick:n,gap:a,children:[e&&r(P,{light:!0,medium:!0,children:e}),C]}),e1=c.div`
    display: flex;
    width: ${e=>e.width||"100%"};
...
`;c(r1)`
  position: absolute;
`;const g=({type:e,label:n,placeholder:l,lightLabel:C})=>o(a1,{children:[r(P,{light:C,children:n}),r(t1,{type:e,placeholder:l})]}),o1=()=>{const e=$();return r(v,{children:o(s,{width:"90vw",height:"90vh",gap:"12px",backgroundColor:"rgba(31, 25, 35, 0.5)",padding:"20px",justify:"start",children:[r(j,{width:"95px",height:"108px"}),r(R,{light:!0,children:"Chat RPG"}),r(g,{label:"Nome",lightLabel:!0}),r(g,{label:"Sobrenome",lightLabel:!0}),r(g,{label:"Username",lightLabel:!0}),r(g,{label:"Email",type:"email",lightLabel:!0}),r(g,{label:"Senha",type:"password",lightLabel:!0}),r(g,{label:"Confirmar senha",type:"password",lightLabel:!0}),o(s,{width:"80%",height:"10%",direction:"row",gap:"12px",backgroundColor:"transparent",overflow:"none",children:[r(p,{label:"Fazer Login",color:t.Green,onClick:()=>e(k(["home"]))}),r(p,{label:"Cadastrar-se",color:t.Gold})]})]})})},Z=()=>{const e=$();return o(s,{width:"90vw",height:"60vh",gap:"12px",backgroundColor:"rgba(31, 25, 35, 0.5)",children:[r(j,{width:"95px",height:"108px"}),r(R,{light:!0,children:"Chat RPG"}),r(g,{placeholder:"Email",label:"E-mail",lightLabel:!0}),r(g,{placeholder:"Senha",label:"Senha",type:"password",lightLabel:!0}),o(s,{width:"80%",height:"10%",direction:"row",gap:"12px",backgroundColor:"transparent",children:[r(p,{label:"Login",color:t.Green}),r(p,{label:"Register",color:t.Gold,onClick:()=>e(k(["register"]))})]})]})},n1=c.header`
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
`,i1=c.div`
    ...
    padding: 10px;
    gap: 24px;
`,G=({children:e})=>o(n1,{children:[o(i1,{children:[r(j,{}),r(R,{light:!0,children:"Chat RPG"})]}),e]}),H=A.create({baseURL:"http://localhost:3030"});A.create({baseURL:{}.VITE_REACT_APP_API_URL,withCredentials:!1,headers:{"Access-Control-Allow-Origin":"*"}});const l1=()=>{const e=$(),[n,l]=L.exports.useState([]);async function C(){const{data:a}=await H.get("/publications");l(a)}return L.exports.useEffect(()=>{C()},[]),o(v,{children:[r(G,{children:r(p,{color:t.Gold,icon:r(F,{size:22,color:t.White.base})})}),r(s,{height:"50px",children:r(p,{label:"Criar Publica\xE7\xE3o",icon:r(I,{size:16,weight:"bold",color:t.White.base}),color:t.Brown,gap:"8px",onClick:()=>e(k(["create-game"]))})}),r(s,{height:"",justify:"start",padding:"0 30px 30px 30px",gap:"12px",children:n.map(a=>r(v,{children:o(s,{backgroundColor:t.Background.base,height:"250px",justify:"center",padding:"10px 16px",gap:"12px",overflow:"none",children:[o(s,{backgroundColor:"transparent",justify:"space-between",align:"center",direction:"row",height:"10%",overflow:"none",children:[r(B,{children:a.title}),o(B,{children:[a.playersAmount,"/",a.playersLimit]})]}),r(s,{height:"50%",backgroundColor:"transparent",justify:"start",align:"start",border:`solid ${t.Coal.base} 1px`,padding:"8px",children:r(y,{children:a.description})}),o(s,{direction:"row",height:"20%",gap:"8px",backgroundColor:"transparent",align:"start",overflow:"none",children:[o("span",{children:[r(p,{label:"Curtir",color:t.Green}),o(E,{children:[a.likes," Curtidas"]})]}),o("span",{children:[r(p,{label:"Comentar",color:t.Brown}),o(E,{children:[a.comments," Coment\xE1rios"]})]}),r(p,{label:"Entrar",color:t.Gold})]})]})}))})]})},s1=c.div`
  display: flex;
  flex-direction: column;
  ...
  gap: 20px;
  overflow: auto;
`,c1=()=>{const e=$(),[n,l]=L.exports.useState({title:"",playersLimit:0,playersAmount:0,characters:[],description:""});async function C(){try{const{data:i}=await H.post("/publications",n);e(k(["feed"]))}catch{}}function a(){let i=[];for(let u=0;u<n.playersLimit;u++)i.push(r(v,{children:o(s,{direction:"column",justify:"center",align:"start",width:"200px",height:"50px",overflow:"none",children:[o(y,{children:["Jogador ",u+1]}),r("input",{type:"text",name:"",id:""})]})}));return i}return L.exports.useEffect(()=>{},[]),o(v,{children:[r(G,{children:r(p,{color:t.Gold,icon:r(F,{size:22,color:t.White.base})})}),r(s1,{children:o(s,{backgroundColor:t.Background.base,justify:"start",padding:"10px 16px",height:"90%",children:[o(s,{backgroundColor:"transparent",justify:"space-between",align:"center",direction:"row",height:"50px",overflow:"hidden",children:[r(B,{children:"Criar jogo"}),r(O,{size:22,color:t.Black.base,onClick:()=>e(-1),onMouseEnter:i=>i.currentTarget.style.cursor="pointer"})]}),o(s,{justify:"start",align:"start",padding:"12px",gap:"12px",overflow:"auto",children:[o(s,{justify:"center",align:"start",overflow:"none",children:[r(y,{children:"T\xEDtulo"}),r("input",{type:"text",name:"title",onChange:i=>l({...n,title:i.target.value})})]}),o(s,{direction:"row",justify:"start",align:"center",gap:"8px",overflow:"none",children:[r(y,{children:"N\xFAmero de jogadores"}),o("select",{name:"",id:"",value:n.playersLimit,onChange:i=>{l({...n,playersLimit:Number(i.target.value)}),a()},color:t.Black.base,children:[r("option",{value:"0",children:"-"}),r("option",{value:"1",children:"1"}),r("option",{value:"2",children:"2"}),r("option",{value:"3",children:"3"}),r("option",{value:"4",children:"4"}),r("option",{value:"5",children:"5"}),r("option",{value:"6",children:"6"}),r("option",{value:"7",children:"7"}),r("option",{value:"8",children:"8"})]})]}),r(s,{flexWrap:"wrap",direction:"row",justify:"start",align:"center",overflow:"none",children:a()}),o(s,{direction:"column",justify:"center",align:"start",backgroundColor:"transparent",overflow:"none",children:[r(y,{children:"Hist\xF3ria"}),r("input",{type:"text",name:"",id:"",onChange:i=>l({...n,description:i.target.value})})]})]}),o(s,{height:"40px",direction:"row",gap:"16px",children:[r(p,{label:"Cancelar",color:t.Red,onClick:()=>e(-1)}),r(p,{label:"Criar",color:t.Green,onClick:()=>C()})]})]})})]})},d1=()=>o(U,{children:[r(f,{path:"*",element:r(Z,{})}),r(f,{path:"/",element:r(_,{to:"/home"})}),r(f,{path:"*",element:r(Z,{})}),r(f,{path:"/register",element:r(o1,{})}),r(f,{path:"/feed",element:r(l1,{})}),r(f,{path:"/create-game",element:r(c1,{})})]});const C1=()=>r(d1,{}),p1=q`
  @import url('https://fonts.googleapis.com/css2?family=Roboto+Mono&family=Roboto:wght@300;400;500;700&display=swap');
`;J.render(o(K,{children:[r(p1,{}),r(C1,{})]}),document.getElementById("root"));
